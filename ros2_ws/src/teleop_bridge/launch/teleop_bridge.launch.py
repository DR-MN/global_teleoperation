...
Pure topic relay: leader forwards /joint_cmd over the transport, follower
republishes it locally as /joint_cmd. No arm drivers, no CAN/serial config —
whatever is downstream of /joint_cmd on the follower machine is out of scope
here.
