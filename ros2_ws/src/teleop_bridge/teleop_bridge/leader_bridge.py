...
Subscribes /joint_cmd (all joints including gripper) and forwards it as-is
over the transport to the remote follower. Pure topic relay — no arm driver,
no feedback path.
...
from teleop.core import SystemConfig, JointCommand, now
